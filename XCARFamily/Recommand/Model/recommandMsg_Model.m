...
@implementation recommandMsg_Model
...
+ (instancetype)carWithDict:(NSDictionary *)dic
{
    ...
    NSArray *properties = [recommandMsg_Model properties];//返回存储着类属性名字的数组
...
+ (NSArray *)dataSourceWithDict:(NSDictionary *)dict key:(NSString *)keyString
{
    ...
    for (NSDictionary *dict in array) {
        recommandMsg_Model *model = [self carWithDict:dict];
